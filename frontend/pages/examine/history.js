...
const history = () => {
    ...
    useEffect(() => {
        ...
        Axios  ({
            url: NEXT_PUBLIC_API_BASE_URL + "/api/getChemicalByGroup?groupname=" + gname,
            method: "get"
          }).then ((response) => {
          ...
          Axios  ({
            url: NEXT_PUBLIC_API_BASE_URL + "/api/getAllChemical",
            method: "get"
          }).then ((response) => {
            if (response.data.status === "ok") {
    ...
    const addData = (e) => {
      // Axios  ({
      //   url: NEXT_PUBLIC_API_BASE_URL + "/api/getChemicalByCas?cas=" + e,
      //   method: "get"
      // }).then ((response) => {
      //   if (response.data.status === "ok") {
      //     let resData = JSON.parse(JSON.stringify(response.data.message))
