    ...
    <Box sx={{ width: '100%', typography: 'body1',marginLeft:{xs:"80px",md:"80px"} ,marginRight:{xs:"80px",md:"80px"} ,marginTop:{xs:"30px",md:"30px"}}}>
      <TabContext value={value}>
        ...
        <TabPanel value="1">
            ...
            <h6>2. สูตรส่วนประกอบของเครื่องสำอาง</h6>
            <p></p>
            <img src="/fomula-ex.png" style={{ maxWidth: 0 + "550px" }}/>
            <p></p>
            <h6>3. ฉลากเครื่องสำอาง</h6><p></p>
            <h6>4. ข้อมูลเกี่ยวกับการผลิต</h6><p></p>
            <h6>5. รายงานสรุปอาการอันไม่พึงประสงค์จากการใช้เครื่องสำอาง (Adverse event report) กรณีมีการเกิดอาการอันไม่พึงประสงค์จากการใช้เครื่องสำอาง</h6><p></p>
            <h6>6. การประเมินความสอดคล้องของการกล่าวอ้างสรรพคุณเครื่องสำอาง ต้องมีข้อมูลสนับสนุนการอ้างประสิทธิภาพหรือสรรพคุณของเครื่องสำอางตามที่กล่าวอ้างบนฉลาก
หรือโฆษณา </h6>
