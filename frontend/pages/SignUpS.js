...
export default function SignUp() {
  ...
  const fetchData = async(data1,e) => {
   let load = {
        orid : sessionStorage.getItem("orid")
    ...
    try {
      ...
      Axios({
        ...
        if (!isValidEmail(data1.em_email)) {
          ...
          console.log(data1)
          Axios({
            url: "http://localhost:3001/api/setsignUpS",
            method: "post",
            headers: { 
            ...
            <Grid container spacing={2}>
              ...
              <div class="dropdown">
                  <button class="dropbtn">สถานะ</button>
                    ...
                    <p onClick={()=>setStatus("U0")}>หัวหน้า</p> 
                    <p onClick={()=>setStatus("U1")}>ผู้แก้ไข</p>
                    <p onClick={()=>setStatus("U2")}>ผู้ใช้พิเศษ</p>
                    </div>
              </div>
              </Grid>
