...
const manage = () => {
  ...
  useEffect(() => {
    ...
    Axios.get(NEXT_PUBLIC_API_BASE_URL + "/api/getStatusByEmail?email="+email)
    .then((res) => {
    ...
    Axios.get(NEXT_PUBLIC_API_BASE_URL + "/api/getUserNoTeam")
      .then((res) => {
        console.log("Data")
    ...
    const feactData1 = async () => {
          let ida = ""
          Axios.get(NEXT_PUBLIC_API_BASE_URL + "/api/getuserTeamMangeByemail?email="+email)
          .then((res) => {
              console.log("Data")
              ...
              if (ida === null) {
                  ...
                  Axios.get(NEXT_PUBLIC_API_BASE_URL + "/api/getuserTeamManage?id="+ida)
                  .then((res) => {
                      console.log("Data")
                      console.log(res.data.message)
  ...
  const add = (e) => {
      ...
      Axios.post(NEXT_PUBLIC_API_BASE_URL + "/api/addUserToTeam",
      {
        team: id,
        no: e,
      })
  ...
  const handleChange = (e) => {
    ...
    Axios.get(NEXT_PUBLIC_API_BASE_URL + "/api/getCountOwner?id="+id)
    .then((res) => {
        console.log(res.data.message[0].num)
        let s_count = res.data.message[0].num
        if (s_count <= 1) {
          Axios.get(NEXT_PUBLIC_API_BASE_URL + "/api/getStatusByNo?no="+e.no)
          .then((res) => {
              console.log(res.data.message[0].status)
  ...
  const updateStatus = (e) => {
    ...
    console.log( "is load from handlechange")
        ...
        Axios.post(NEXT_PUBLIC_API_BASE_URL + "/api/updateManageUser", dataChangeStatus)
        .then(response => {
  ...
  const deleteTeamCheck = (e) => {
    ...
    console.log(load)
    Axios.post(NEXT_PUBLIC_API_BASE_URL + "/api/deleteTeam", load)
    .then(response => {
  ...
  const deleteMember = (e) => {
    ...
    console.log("load from delete")
    console.log(load)
    Axios.post(NEXT_PUBLIC_API_BASE_URL + "/api/getuserDeleteAdmin", load)
    .then(response => {
      if (response.data.status === "ok") {
        Swal.fire({
            title: "สำเร็จ!",
  ...
  const changeName = async () => {
    ...
    try {
        const res = await Axios.post(NEXT_PUBLIC_API_BASE_URL + "/api/changeNameTeam", load);
